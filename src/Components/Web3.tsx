    ...
    return(
        ...
        <main className="relative flex mt-8 sm:mt-10 md:mt-20 lg:mt-36 flex-col-reverse sm:flex-row items-center justify-between">
            ...
            <div className='relative w-full md:w-1/2  h-[350px] sm:h-[400px] md:static overflow-hidden'>
                <Spline data-aos="zoom-in" data-aos-duration='2000' className='absolute  top-0 bottom-0 sm:left-[-2%] md:left-[25%] h-[350px] w-auto md:h-full  sm:h-[400px]' scene="https://prod.spline.design/kiz3gNI7M8iXZJ3F/scene.splinecode"    />
